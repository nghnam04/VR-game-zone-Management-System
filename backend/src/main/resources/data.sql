...
(2, 6, 6, 6, NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 5 DAY + INTERVAL 2 HOUR, 'CANCELLED', 4, 330.00, 'UNPAID'),
(3, 9, 9, 9, NOW() - INTERVAL 8 DAY, NOW() - INTERVAL 8 DAY + INTERVAL 1.75 HOUR, 'CANCELLED', 1, 250.00, 'UNPAID'),
(4, 10, 10, 10, NOW() - INTERVAL 9 DAY, NOW() - INTERVAL 9 DAY + INTERVAL 1.5 HOUR, 'PENDING', 4, 440.00, 'UNPAID'),
(5, 11, 1, 1, NOW(), NOW() + INTERVAL 1 HOUR, 'PENDING', 3, 360.00, 'UNPAID'),
(6, 12, 2, 2, NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY + INTERVAL 2 HOUR, 'ACCEPTED', 4, 220.00, 'PAID'),
(7, 13, 4, 4, NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 3 DAY + INTERVAL 1.5 HOUR, 'PENDING', 3, 195.00, 'UNPAID'),
(8, 14, 5, 5, NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 4 DAY + INTERVAL 1.2 HOUR, 'ACCEPTED', 5, 550.00, 'PAID'),
(9, 15, 7, 7, NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 6 DAY + INTERVAL 0.45 HOUR, 'PENDING', 5, 300.00, 'UNPAID'),
